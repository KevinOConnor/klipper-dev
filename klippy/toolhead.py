...
class Move:
    ...
    def calc_junction(self, prev_move):
        ...
        ea_v2 = [ea.calc_junction(prev_move, self, ea_index+3)
                 for ea_index, ea in enumerate(self.toolhead.extra_axes)]
...
class ToolHead:
    ...
    def _process_moves(self, moves):
        ...
        for move in moves:
            ...
            for ea_index, ea in enumerate(self.extra_axes):
                if move.axes_d[ea_index + 3]:
                    ea.process_move(next_move_time, move, ea_index + 3)
    ...
    def set_position(self, newpos, homing_axes=""):
        ...
        self.commanded_pos[:3] = newpos[:3] # XXX
    ...
    def add_extra_axis(self, ea, axis_pos):
        ...
        ea_index = len(self.commanded_pos)
